...
def Play():
    ...
    print(song)
    song=f'C:/Users/andro/Music/{song}'
...
def Previous():
    ...
    temp2=f'C:/Users/andro/Music/{temp2}'
...
def Next():
    ...
    temp=f'C:/Users/andro/Music/{temp}'
...
#play button
play_button=Button(root,text="Play",width =9,command=Play)
play_button['font']=defined_font
play_button.grid(row=1,column=0)

#pause button 
pause_button=Button(root,text="Pause",width =9,command=Pause)
...
#nextbutton
next_button=Button(root,text="Next",width =9,command=Next)
